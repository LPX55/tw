 ...
 *
 * @return {Object} InvestOptionsDayTrnLogs
 *
...
(function(root) {
    ...
    this.getSchemaJSONObject = function() {
      ...
      var result = _.extend({}, uber.getSchemaJSONObject());
			...
			result.$schema = '/json-schema/VO/InvestOptionsDayTrnLogs';
			result.title = 'invest_options_day_trn_logs';
	...
	if (typeof define === 'function') {
		...
		root.tw.ace33022.vo.InvestOptionsDayTrnLogs = result;
	}
})(this);