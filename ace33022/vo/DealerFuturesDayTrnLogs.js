/**
 *
 * DealerFuturesDayTrnLogs
 *
 * @author ace
 *
 * @version 2013/10/29 初始版本。
...
(function(root) {
    ...
    this.getSchemaJSONObject = function() {
      ...
      var result = _.extend({}, uber.getSchemaJSONObject());
			...
			result.$schema = '/json-schema/VO/DealerFuturesDayTrnLogs';
			result.title = 'dealer_futures_day_trn_logs';
	...
	if (typeof define === 'function') {
		...
		root.tw.ace33022.vo.DealerFuturesDayTrnLogs = result;
	}
})(this);