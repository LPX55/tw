...
(function(root) {
    ...
    this.getSchemaJSONObject = function() {
      ...
      var result = _.extend({}, uber.getSchemaJSONObject());
			...
			result.$schema = '/json-schema/VO/DealerFuturesOptionsDayTrnLogs';
			result.title = 'dealer_futures_options_day_trn_logs';
	...
	if (typeof define === 'function') {
		...
		root.tw.ace33022.vo.DealerFuturesOptionsDayTrnLogs = result;
	}
})(this);